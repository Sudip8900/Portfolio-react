  ...
  return (
    <div className="relative w-full h-full">
      <canvas
        ...
        ref={canvasRef}
        className="cursor-grab w-full h-full overflow-hidden relative outline-none active:cursor-grabbing rounded-4xl"
      />
      ...
      {activeItem && (
        ...
        `}
          >
            <p className="select-none relative text-white -top-1 text-[26px]">&#x2197;</p>
          </div>
        </>
      )}
    </div>
